...
namespace KCharacterControler.Examples.Teleport
{
    /// <summary>
    /// This example shows how to teleport a character and orient it (if enabled) towards a destination forward preserving its momentum.
    /// </summary>
