...
namespace KCharacterControler
{
    ...
    public partial class Character : MonoBehaviour
    {
        ...
        // Deprecated: moved to DefaultCharacterPhysicsVolumeHandler
        protected readonly List<PhysicsVolume> _physicsVolumes = new List<PhysicsVolume>();

        // Deprecated: managed by ICharacterAutoSimulationHandler
        ...
        /// <summary>
        /// Increments falling time by deltaTime.
        /// </summary>
        
        protected internal void AddFallingTime(float deltaTime)
        {
        ...
        {
            // Backwards compatibility for external callers. Redirect to handler.
            InitializePhysicsHandlers();
            _autoSimulationHandler.SetEnabled(enable);
        }
        ...
        {
            InitializePhysicsHandlers();
            _physicsVolumeHandler.Add(other);
        }
        ...
        {
            InitializePhysicsHandlers();
            _physicsVolumeHandler.Remove(other);
        }
        ...
        {
            InitializePhysicsHandlers();
            _physicsVolumeHandler.UpdateVolumes();
        }
        ...
        protected internal virtual void RotateWithRootMotion()
        {
        ...
        protected internal virtual void CalcDesiredVelocity(float deltaTime)
        {
            InitializeMovementHandlers();
            _desiredVelocity = _velocityPlanner.CalcDesiredVelocity(deltaTime);
        }
        ...
        protected internal virtual void WalkingMovementMode(float deltaTime)
        {
            InitializeMovementHandlers();
            _movementModeHandler.UpdateWalking(deltaTime);
        }
        ...
        protected internal virtual void FallingMovementMode(float deltaTime)
        {
            InitializeMovementHandlers();
            _movementModeHandler.UpdateFalling(deltaTime);
        }
        ...
        protected internal virtual void FlyingMovementMode(float deltaTime)
        {
            InitializeMovementHandlers();
            _movementModeHandler.UpdateFlying(deltaTime);
        }
        ...
        protected internal virtual void SwimmingMovementMode(float deltaTime)
        {
            InitializeMovementHandlers();
            _movementModeHandler.UpdateSwimming(deltaTime);
        }
        ...
        protected internal virtual void UpdateRotation(float deltaTime)
        {
            InitializeMovementHandlers();
            _rotationHandler.UpdateRotation(deltaTime);
        }
        ...
        protected internal virtual void CustomRotationMode(float deltaTime)
        {
